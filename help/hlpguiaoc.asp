...
cad = "select * from guia where (cliente not in (select a.cliente from guia as a  right join ordcom_cab as b on ltrim(rtrim(a.cliente))=ltrim(rtrim(b.cliente)) and ltrim(rtrim(a.po))=ltrim(rtrim(b.po)) and ltrim(rtrim(a.estilo))=ltrim(rtrim(b.estilo))) and  po not in  (select a.po from guia as a  right join ordcom_cab as b on ltrim(rtrim(a.cliente))=ltrim(rtrim(b.cliente)) and ltrim(rtrim(a.po))=ltrim(rtrim(b.po)) and ltrim(rtrim(a.estilo))=ltrim(rtrim(b.estilo))) and estilo not in (select a.estilo from guia as a  right join ordcom_cab as b on ltrim(rtrim(a.cliente))=ltrim(rtrim(b.cliente)) and ltrim(rtrim(a.po))=ltrim(rtrim(b.po)) and ltrim(rtrim(a.estilo))=ltrim(rtrim(b.estilo)))) and cliente like '%" & request.queryString("cliente") & "%' and po like '%" & request.queryString("po") & "%' and estilo like '%" & request.queryString("estilo") & "%'"
'response.write(cad)
